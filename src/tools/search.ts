  ...
  server.tool(
    ...
    "Search the Obsidian vault content using a text query. Supports scoping to a path, limiting results, choosing output format, including match context, and case-sensitive matching.",
    {
      ...
      path: z
        .string()
        .optional()
        .describe("Vault-relative path to scope the search to"),
      limit: z
        .number()
        .optional()
      ...
      matches: z
        .boolean()
        .optional()
        .describe("If true, include matching line context in results"),
      case_sensitive: z
        .boolean()
        .optional()
        .describe("If true, perform case-sensitive search"),
    },
    async ({ query, path, limit, format, matches, case_sensitive }) => {
      ...
      if (case_sensitive) flags.push("--case");
